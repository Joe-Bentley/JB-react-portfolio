...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-auto text-[#1C1C1C] dark:text-gray-300 flex justify-center items-center p-4 my-auto'>
      <form method="POST" action="https://getform.io/f/52b92735-f00e-4e17-9383-61bc03185c0e" className='flex flex-col max-w-[1000px] w-full'>
          <div className='pb-8'>
          ...
          <button className='border-2 border-gray-500 px-4 py-3 my-8 flex items-center hover:bg-[#FF0000] hover:text-white sm:w-fit w-full justify-center sm:justify-start'>Submit <HiArrowNarrowRight className='ml-3'/>
          </button>
