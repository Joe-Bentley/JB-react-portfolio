...
const About = () => {
  return (
    <div name='about' className='w-full md:h-[60vh] h-[80vh] bg-white text-[#1C1C1C] dark:bg-[#1C1C1C] dark:text-gray-300'>
      <div className='flex flex-col justify-center items-center w-full md:h-[35vh]'>
