      ...
      <div className="flex flex-nowrap">
        <div className="w-full">
          <ul
            ...
            role="tablist"
          >
            <li className="-mb-px mr-2 last:mr-0 flex-auto text-center border-b-4 focus-within:bg-[#FF0000] focus-within:text-white">
              <a
            ...
            <li className="-mb-px mr-2 last:mr-0 last:mt-1 flex-auto text-center border-b-4 focus-within:bg-[#FF0000] focus-within:text-white">
              <a
                className="text-1xl uppercase px-5 py-3 block leading-normal"
                onClick={(e) => {
                  e.preventDefault();
